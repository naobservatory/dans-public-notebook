...
```{r}
#| label: geom-means
#| fig-cap: Geometric mean cumulative incidence at detection. Ratio is wastewater CI / swab CI. Ratio < 1 favors wastewater; ratio > 1 favors swabs.
...
#| fig-subcap: Vertical bars are 15, 50, and 85th percentiles. Ratio < 1 favors wastewater; ratio > 1 favors swabs.
